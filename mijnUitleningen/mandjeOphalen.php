...
if (true) {
  $stmt = $conn->prepare("SELECT DISTINCT MIJN_LENINGEN.in_bezit, MIJN_LENINGEN.Uitleendatum, MIJN_LENINGEN.terugbrengDatum, GROEP.naam AS groep_naam, PRODUCT.product_id, lening_id
  FROM MIJN_LENINGEN
