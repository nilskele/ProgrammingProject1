    ...
    <div class="container main-container">
      <div class="card">
        <div class="row">
          <div class="col-md-4">
            <!-- Image -->
            <img src="data:image/jpg;base64,<?php echo ($product['image_data']); ?>" class="card-img-top img-fluid"
              alt="Main Image">
          </div>
          <div class="col-md-8">
            <!-- Product details -->
            <div class="card-body">
              ...
              <div class="num mb-2">
                ...
                <h5 class="maxAantal">Aantal beschikbaar: <span
                    id="aantalBeschikbaar"><?php echo htmlspecialchars($product['aantal_beschikbare_producten']); ?></span>
                </h5>
              </div>
            </div>
          </div>
